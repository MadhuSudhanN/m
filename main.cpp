...
void display()
{
	...
	else if (instflag == true)
	{
		...
		drawString(23,49,0,GLUT_BITMAP_HELVETICA_18,"    such as buildings and clouds,ground higher altitude above cloud.");
		drawString(23,45,0,GLUT_BITMAP_HELVETICA_18,"* Also the meter at the bottom shows the distance and level ");
		drawString(23,41,0,GLUT_BITMAP_HELVETICA_18,"- press 'p' or 'P' to pause and press 'e' to exit");
	...
	else if (abtflag == true)
	{
		...
		drawString(23,53,0,GLUT_BITMAP_HELVETICA_18,"            Madhu sudhan N and Pavan kumar N");
...
int main(int argc, char** argv)
{
		...
		printf("-->Also the meter at the bottom shows the distance travelled and LEVEL.\n");
		printf("\n");
